...
scaledcars[c("wt", "disp", "lp100km")] <- scale(scaledcars[c("wt", "disp", "lp100km")])
```
...
We used weakly informative priors, recommended as good default priors in [Gelman (2008)](http://www.stat.columbia.edu/~gelman/research/published/priors11.pdf). Te prior for $\alpha$ is a Caucy distribution with center 0 and scale 10. As priors for the regression coefficients $\beta$ we used a Student's t distribution with 3 degrees of freedom, mean 0 and standard deviation 2 for weight and displacement and standard deviation 3 for gearbox. The rule of thumb of weakly informative distributions is that the standard deviation of the posterior distribution should be less than 0.1 times that of the prior. The standard deviations of the priors were chosen so that this rule was respected.

The Student's t distributions have narrower tails than the Cauchy distribution with center 0 and scale 2.5 originally recommended in [Gelman (2008)](http://www.stat.columbia.edu/~gelman/research/published/priors11.pdf), and has later been observed to perform better, as noted in the [Stan prior choice recommendations](https://github.com/stan-dev/stan/wiki/Prior-Choice-Recommendations). 
